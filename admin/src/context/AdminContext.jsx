...
const getDashData=async()=>{
    ...
    const value={
aToken,setAToken,backendUrl,mentors,getAllMentors,changeAvailability,appointments,setAppointments,getAllAppointments,cancelAppointment,dashData,getDashData
    }
    return(
